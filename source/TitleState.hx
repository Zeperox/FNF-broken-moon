...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Broken Moon Mod'], 45);
					addMoreText('Originally made by', 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Gabe', 45);
					addMoreText('BlackTiger', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['FNF is originally from'], -60);
				case 7:
					addMoreText('This site right here', -60);
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Moon'); // credTextShit.text += '\nFunkin';
