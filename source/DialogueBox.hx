...
class DialogueBox extends FlxSpriteGroup
{
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == 'native-faith')
			portraitLeft.visible = false;
		if (PlayState.SONG.song.toLowerCase() == 'ancient-battlefield')
		{
			portraitLeft.visible = false;
			...
			if (dialogueEnded)
			{
				...
				if (dialogueList[1] == null && dialogueList[0] != null)
				{
					if (!isEnding)
					{
						...
						if (PlayState.SONG.song.toLowerCase() == 'transient' || PlayState.SONG.song.toLowerCase() == 'ancient-battlefield')
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				{
					if (PlayState.SONG.song.toLowerCase() == 'transient') portraitLeft.visible = true;
