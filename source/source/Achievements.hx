...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Kappa Kappa!",				"Beat Week 1 on Hard with no Misses.",				'Nitori_nomiss',		false],
		["Crazy Backup Rapper!",		"Beat Week 2 on Hard with no Misses.",				'Door_nomiss',			false],
		["Master Rapper!",				"Beat Week 3 on Hard with no Misses.",				'Witchcraft_nomiss',	false],
		["Becoming the Cheif Maid?",	"Beat Week 4 on Hard with no Misses.",				'Sakyua_nomiss',		false],
		["Party Animal!",				"Beat Week 5 on Hard with no Misses.",				'GensokyoParty_nomiss',	false],
		["Simulation Success!",			"Beat Week 6 on Hard with no Misses.",				'MoriaShrine_nomiss',	false],
		["What a Funkin' Disaster!",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["Feels like a 1cc",			"Complete a Song with a perfect 100%.",				'ur_good',				false],
		["Oversinging Much...?",		"Hold down a note for 20 seconds.",					'oversinging',			false],
		["Hyperactive",					"Finish a Song without going Idle.",				'hype',					false],
		["Just the Two of Us",			"Finish a Song pressing only two keys.",			'two_keys',				false],
		["Reminds me of my laptop",		"Have you tried to run the game on a toaster?",		'toastie',				false],
		["lazy gameplay.",				"I see what your doing.",							'botplayer',			 true],
		["The Strongest Rapper",		"beat a song with 9% rating",						'baka',					 true]
	];
